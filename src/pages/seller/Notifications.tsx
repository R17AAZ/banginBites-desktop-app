...
import { Bell, Clock, ShoppingBag, Info, RefreshCcw } from 'lucide-react';
  ...
  return (
    <div className="w-full space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold font-heading text-neutral-900">Seller Notifications</h1>
          <p className="text-neutral-500 font-sans">Stay updated with your kitchen orders and customer reviews.</p>
        </div>
        ...
        {notifications.length === 0 ? (
          <Card className="border-dashed border-2 border-neutral-200 bg-neutral-50">
            <CardContent className="p-12 flex flex-col items-center justify-center text-center">
              ...
              <p className="text-neutral-500 max-w-xs">We'll notify you about new orders and reviews.</p>
            </CardContent>
          </Card>
        ) : (
          notifications.map((n) => (
